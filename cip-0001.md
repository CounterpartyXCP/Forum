...
Each CIP must have a champion -- someone who writes the CIP using the style and format described below, shepherds the discussions in the appropriate forums, and attempts to build community consensus around the idea. The CIP champion (a.k.a. Author) should first attempt to ascertain whether the idea is CIP-able. Posting to the [Counterparty Forums](https://forums.counterparty.io/c/development/), posting it in the [Counterparty Github Discussions](https://github.com/CounterpartyXCP/cips/discussions) or discussing it in the [Counterparty Developer Telegram](https://t.me/Counterparty_Dev) is the best way to go about this.
