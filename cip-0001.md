...
The CIP editors assign CIP numbers and change their status. Please send all CIP-related email to the CIP editor, which is listed under [CIP Editors](#CIP_Editors) below. Also see [CIP Editor Responsibilities & Workflow](#CIP_Editor_Responsibilities__Workflow).
