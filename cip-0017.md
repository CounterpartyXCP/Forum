...
Counterparty bets have binomial payouts. CFDs were disabled due to a bug, combined with the belief that smart contracts were coming. CFDs, combined with the above mentioned improvements can be implemented later.
