...
Unmathed bets have a user-defined blocks until expiry. Ideally the protocol will give an option to set expiry at a certain block height. For the fee level bet, in particular, this is useful as the expiry should be no later than ten blocks ahead of the feed.
